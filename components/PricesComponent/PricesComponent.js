...
const PricesComponent = () => {
    return (
        <Box sx={{ background: 'linear-gradient(black, beige)' }}>
            <Box display='flex' flexDirection="column" sx={{ maxWidth: '1620px', margin: '0 auto ' }}>
                <Box>
                    <Typography variant="h1" sx={{ paddingLeft: '60px', fontFamily: 'Roboto' }}>Prices </Typography>
                    <Box gap='20px' display="flex" justifyContent="center"  flexWrap="wrap" sx={{ padding: '60px', margin: '0 0  60px 0' }}>
                        <Box position="relative" overflow="hidden" height={400} sx={{ borderRadius: '30px', boxShadow: '0 25px 50px -12px rgb(0 0 0 / 0.25)' }}>
                            <Typography fontStyle="italic" fontFamily="Roboto" fontWeight="bold" color='gold' variant="h2" position="absolute" bottom={5} left={60} zIndex="2">Haircut</Typography>
                        ...
                        <Box position="relative" overflow="hidden" height={400} sx={{ borderRadius: '30px', boxShadow: '0 25px 50px -12px rgb(0 0 0 / 0.25)' }}>
                            <Typography fontStyle="italic" fontFamily="Roboto" fontWeight="bold" color='gold' variant="h2" position="absolute" bottom={5} left={60} zIndex="2">Kids</Typography>
                        ...
                        <Box position="relative" overflow="hidden" height={400} sx={{ borderRadius: '30px', boxShadow: '0 25px 50px -12px rgb(0 0 0 / 0.25)' }}>
                            <Typography fontStyle="italic" fontFamily="Roboto" fontWeight="bold" color='gold' variant="h2" position="absolute" bottom={5} left={60} zIndex="2">Shaving</Typography>
                        ...
                        <Box position="relative" overflow="hidden" height={400} sx={{ borderRadius: '30px', boxShadow: '0 25px 50px -12px rgb(0 0 0 / 0.25)' }}>
                            <Typography fontStyle="italic" fontFamily="Roboto" fontWeight="bold" color='gold' variant="h2" position="absolute" bottom={5} left={60} zIndex="2">Washing</Typography>
