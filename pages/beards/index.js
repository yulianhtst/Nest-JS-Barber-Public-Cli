...
import BeardsPageImg1 from "@/public/backgrounds/BeardsPageImg1.png"
    ...
    return (
        <>
            <Box position="relative">
                ...
                <Typography fontFamily="Roboto" position="absolute" variant="h1" sx={{ right: '10rem', bottom: '3rem' }}>Beards for everyone</Typography>
            </Box >

            <Box display="flex" flexDirection="column" sx={{ width: '100vw' }}>

                <Box display="flex" justifyContent='center' alignItems="center" sx={{ padding: '4rem 14rem', }}>
                    <Box sx={{ paddingRight: '15rem', width: '55rem' }}>
                        <Typography fontFamily="Roboto" sx={{ marginBottom: '5rem' }} variant="h3">Welcome to [Barbershop Name]</Typography>
                        <Typography fontFamily="Roboto" sx={{ fontSize: '1.2rem' }} >At [Barbershop Name], we believe that a haircut is more than just a trim; it's an experience. Step into our world of style, sophistication, and relaxation, where every visit is an opportunity to elevate your look and rejuvenate your spirit. Your grooming needs are unique, and we understand that. That's why we offer a wide range of services to cater to your preferences. From traditional cuts and hot towel shaves to beard trims and styling advice, our barbers will work closely with you to achieve the look you desire.</Typography>
                    </Box>
                    <Image src={BeardsPageImg1} alt="haircut" style={{ width: '640px', height: '100%', padding: '50px 0' }} />
                </Box>
                <Box display="flex" justifyContent='center' alignItems="center" sx={{ padding: '4rem 14rem', }}>
                    <Image src={imgsrcchair} alt="haircut" style={{ height: "100%", padding: '50px 0' }} />
                    <Box sx={{ paddingLeft: '15rem', width: '55rem' }}>
                        <Typography fontFamily="Roboto" sx={{ marginBottom: '5rem', textAlign: 'right' }} variant="h3">The Ultimate Grooming Experience:</Typography>
                        <Typography fontFamily="Roboto" sx={{ fontSize: '1.2rem', textAlign: 'right' }} >We've created an atmosphere where you can unwind and indulge in the ultimate grooming experience. From the moment you enter, you'll be greeted by our friendly staff and surrounded by a blend of modern aesthetics and classic charm. Our comfortable chairs, soothing music, and attention to detail ensure that every visit is a moment of relaxation and pampering.</Typography>
                    </Box>
                </Box>
            </Box>

            <Box display="grid" gridTemplateColumns="repeat(3,1fr)" bgcolor="#efebe9" sx={{ padding: '3rem' }}>
                <Box color='black' gridColumn="1/3 " sx={{ alignSelf: 'center', justifySelf: 'center' }}>
                    <Image src={imgsrcsaloon} style={{ width: '100%', height: '100%' }} />
                </Box>

                <Box color="black" sx={{ padding: '0 10rem', width: '55rem', justifySelf: 'center', alignSelf: 'center' }}>
                    <Typography fontFamily="Roboto" sx={{ marginBottom: '5rem', }} variant="h3">Visit Us Today:</Typography>
                    <Typography fontFamily="Roboto" sx={{ fontSize: '1.2rem' }} >
